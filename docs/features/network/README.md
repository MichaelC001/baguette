...
Like [`motion`](../motion/README.md) and unlike [`location`](../location/README.md), **there is
...
Same division of labour [motion](../motion/README.md#why-an-intent-not-a-sample-stream)
has.

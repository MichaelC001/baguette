...
[`capture-size.md`](../capture-size/README.md), so `--size appstore-6.9` on the
...
[`capture-size.md`](../capture-size/README.md) for the preset table and the
...
| `--size` | `native` | Output size, from [`capture-size.md`](../capture-size/README.md) |
...
The 3D viewport (see [`3d-rendering.md`](../3d-rendering/README.md)) paints a

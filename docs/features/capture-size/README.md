...
Screenshots are covered in [`screenshot.md`](../screenshot/README.md),
recordings in [`recording.md`](../recording/README.md), and the 3D device
render in [`3d-rendering.md`](../3d-rendering/README.md). This doc is scoped to
...
request. See [`3d-rendering.md`](../3d-rendering/README.md).

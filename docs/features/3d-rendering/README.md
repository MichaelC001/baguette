...
[`capture-size.md`](../capture-size/README.md) defines — the preset
...
[`device-twin.md`](../device-twin/README.md); the two simulator keys are
...
iPhone Duo's definition ([`iphone-duo.md`](../iphone-duo/README.md)) uses the
...
margins instead — see [Recording the 3D stage](../recording/README.md#recording-the-3d-stage).
...
[`capture-size.md`](../capture-size/README.md)):
...
and simply turns the bezel off. See [`recording.md`](../recording/README.md).

...
the Device Hub heal from [`device-hub.md`](../device-hub/README.md) applies to
...
[`companion-screens.md`](../companion-screens/README.md) had read as a near-miss.
...
([`3d-rendering.md`](../3d-rendering/README.md)). `Models3D/iphone-duo/
...
[`hinge.md`](../hinge/README.md)); SpringBoard swaps panels and the book follows
...
/simulators/<udid>/hinge` — see [`hinge.md`](../hinge/README.md) for the route

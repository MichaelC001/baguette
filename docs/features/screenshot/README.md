...
[`capture-size.md`](../capture-size/README.md) — `--size appstore-6.9` on the
...
[`recording.md`](../recording/README.md). This doc is scoped to single-frame
...
The preset table lives in [`capture-size.md`](../capture-size/README.md) and is
...
rectangle. See [`chrome-bezel.md`](../chrome-bezel/README.md) for which devices
ship chrome.
...
- **Ratios grow, they never crop.** `--size square` on a phone gives a
  ...
  [`capture-size.md`](../capture-size/README.md)), but it does mean `--size 16:9`

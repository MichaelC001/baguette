...
[`describe-ui`](../accessibility/README.md) wire protocol. Where the wire
...
Wire shape mirrors [`accessibility.md`](../accessibility/README.md) exactly —
...
- [`accessibility.md`](../accessibility/README.md) — the wire protocol the
